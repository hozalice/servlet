...
public class SalaryImportController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Part componentsFile = request.getPart("components");
            Part salarySlipsFile = request.getPart("salarySlips");
            ...
            if (employeesFile == null || componentsFile == null || salarySlipsFile == null) {
                sendError(response, "Tous les fichiers sont requis (employees, components, salarySlips)", 400);
                return;
            }
            ...
            try (InputStream employeesStream = employeesFile.getInputStream();
                ...
                sendError(response, "Erreur lors du traitement des fichiers: " + e.getMessage(), 500);
            }
